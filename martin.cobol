               ...
               READ freservation
                   ...
                   NOT INVALID KEY DISPLAY
                       ...
                       DISPLAY "? Numero de client :                   "
                               " ?"
                       ACCEPT fr_numCl
                       DISPLAY "? Jour de d�but de la reservation :    "
                               " ?"
                       ACCEPT fr_date_debut_day
                       DISPLAY "? Mois de d�but de la resevration :    "
                               " ?"
                       ACCEPT fr_date_debut_month
                       DISPLAY "? Ann�e de d�but de la reservation :   "
                               " ?"
                       ACCEPT fr_date_debut_year
                       DISPLAY "? Heure de d�but de la rervation :     "
                               " ?"
                       ACCEPT fr_date_debut_hours
                       DISPLAY "? Minute de d�but de la resevation :   "
                               " ?"
                       ...
                       DISPLAY "? Ann�e de fin de la reservation :     "
                               " ?"
